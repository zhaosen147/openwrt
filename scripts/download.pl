...
foreach my $mirror (@ARGV) {
	if ($mirror =~ /^\@SF\/(.+)$/) {
		...
		push @mirrors, "https://chinanet.mirrors.ustc.edu.cn/apache/$1";
		...
		push @mirrors, "https://chinanet.mirrors.ustc.edu.cn/gnu/$1";
		...
		foreach my $dir (@extra) {
			push @mirrors, "https://chinanet.mirrors.ustc.edu.cn/kernel.org/$dir";
		...
		push @mirrors, "https://chinanet.mirrors.ustc.edu.cn/gnome/sources/$1";
