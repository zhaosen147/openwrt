...
#define MV_PORTCTRL1_TRUNK	(1 << 14)
#define MV_PORTCTRL1_TRUNK_ID_MASK (0xf << 4)
...
enum {
	MV_GLOBAL2_TRUNK_MASK	= 0x07,
	MV_GLOBAL2_TRUNK_MEMBER	= 0x08,
...
#define MV_TRUNK_UPDATE			(1 << 15)
#define MV_TRUNK_HASH			(1 << 11)
#define MV_TRUNK_MEMBER_MASK	0x07ff
#define MV_TRUNK_ID_NUM_MASK	0x7000
#define MV_TRUNK_ID_NUM_SHIFT	12
